...
class _ApiService implements ApiService {
  ...
  Future<Tickets> getTickets() async {
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/v3/2dbc0999-86bf-4c08-8671-bac4b7a5f7eb',
  ...
  Future<Offers> getOffers() async {
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/v3/00727197-24ae-48a0-bcb3-63eb35d7a9de',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<TicketsOffers> getTicketOffers() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/v3/3424132d-a51a-4613-b6c9-42b2d214f35f',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
